      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
              <li><a href="#" id="pag1">Personal</a></li>
            <li><a href="#" id="pag2">Usuarios</a></li>
            </ul>
        </li>
         <li class="dropdown">
          <a class="dropdown-toggle" data-toggle="dropdown" href="#">Cuentas<span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="#" id="RegistroUsuario">usuario</a></li>
            <li><a href="#" id="RegistroPersonal">Personal</a></li>
            <li><a href="#" id="RegistroNivel">Nivel</a></li>
            </ul>
        </li>
        <li><a href="#" id="RegistroProyecto">Proyecto</a></li>
        <li><a href="#" id="RegistroCategoria">Categoria</a></li>
        <li><a href="#" id="RegistroEstado">Estado</a></li>
        <li><a href="#" id="RegistroPrioridad">Prioridad</a></li>
